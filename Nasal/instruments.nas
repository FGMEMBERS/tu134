...
if( getprop("yak40/systems/svs/powered") != 1 ) return;
var alt = getprop("instrumentation/altimeter/indicated-altitude-ft");
if( alt == nil ) { return; }

alt = alt * 0.3048;	# go to meters

setprop("yak40/instrumentation/altimeter/indicated-wheels_dec_m", 
(alt/10.0) - int( alt/100.0 )*10.0 );

setprop("yak40/instrumentation/altimeter/indicated-wheels_hund_m", 
(alt/100.0) - int( alt/1000.0 )*10.0 );

setprop("yak40/instrumentation/altimeter/indicated-wheels_ths_m", 
(alt/1000.0) - int( alt/10000.0 )*10.0 );

setprop("yak40/instrumentation/altimeter/indicated-wheels_decths_m", 
...
setprop("yak40/instrumentation/altimeter/mmhg", pressure );

setprop("yak40/instrumentation/altimeter/mmhg-wheels_dec", 
(pressure/10.0) - int( pressure/100.0 )*10.0 );

setprop("yak40/instrumentation/altimeter/mmhg-wheels_hund", 
